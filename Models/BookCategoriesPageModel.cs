...
namespace Dinu_Alexandra_Lab2.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        ...
        public void PopulateAssignedCategoryData(Dinu_Alexandra_Lab2Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Dinu_Alexandra_Lab2Context context,
        string[] selectedCategories, Book bookToUpdate)
        {
            ...
            foreach (var cat in context.Category.ToList())
            {
